...
[`mlr3torch::TorchOptimizer`](https://mlr3torch.mlr-org.com/dev/reference/TorchOptimizer.md),
[`mlr3torch::TorchLoss`](https://mlr3torch.mlr-org.com/dev/reference/TorchLoss.md),
and
[`mlr3torch::TorchCallback`](https://mlr3torch.mlr-org.com/dev/reference/TorchCallback.md)
classes.
...
which has no parameters and merely saves the training and validation
