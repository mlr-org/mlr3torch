...
Calls
[`torch::nn_conv1d()`](https://torch.mlverse.org/docs/reference/nn_conv1d.html)
...
-\>
[`PipeOpTorch`](https://mlr3torch.mlr-org.com/dev/reference/mlr_pipeops_torch.md)
-\> `PipeOpTorchConv` -\> `PipeOpTorchConv1D`

## Methods

### Public methods

- [`PipeOpTorchConv1D$new()`](#method-PipeOpTorchConv1D-initialize)

- [`PipeOpTorchConv1D$clone()`](#method-PipeOpTorchConv1D-clone)
...
pipeop = nn("conv1d", kernel_size = 10, out_channels = 1)
pipeop
#> 
#> ── PipeOp <conv1d>: not trained ────────────────────────────────────────────────
