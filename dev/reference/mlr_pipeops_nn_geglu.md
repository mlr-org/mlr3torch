...
Gaussian Error Linear Unit Gated Linear Unit (GeGLU) activation
function, see
...
- [`PipeOpTorchGeGLU$new()`](#method-PipeOpTorchGeGLU-initialize)

- [`PipeOpTorchGeGLU$clone()`](#method-PipeOpTorchGeGLU-clone)
