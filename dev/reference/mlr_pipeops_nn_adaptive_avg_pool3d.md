...
Calls
[`nn_adaptive_avg_pool3d()`](https://torch.mlverse.org/docs/reference/nn_adaptive_avg_pool3d.html)
during training.
...
-\>
[`PipeOpTorch`](https://mlr3torch.mlr-org.com/dev/reference/mlr_pipeops_torch.md)
-\> `PipeOpTorchAdaptiveAvgPool` -\> `PipeOpTorchAdaptiveAvgPool3D`

## Methods

### Public methods

- [`PipeOpTorchAdaptiveAvgPool3D$new()`](#method-PipeOpTorchAdaptiveAvgPool3D-initialize)

- [`PipeOpTorchAdaptiveAvgPool3D$clone()`](#method-PipeOpTorchAdaptiveAvgPool3D-clone)
...
pipeop = nn("adaptive_avg_pool3d")
pipeop
#> 
#> ── PipeOp <adaptive_avg_pool3d>: not trained ───────────────────────────────────
#> Values: list()
#> 
#> ── Input channels: 
#>    name           train predict
