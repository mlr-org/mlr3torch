...
Calls
[`torch::nn_conv3d()`](https://torch.mlverse.org/docs/reference/nn_conv3d.html)
...
-\>
[`PipeOpTorch`](https://mlr3torch.mlr-org.com/dev/reference/mlr_pipeops_torch.md)
-\> `PipeOpTorchConv` -\> `PipeOpTorchConv3D`

## Methods

### Public methods

- [`PipeOpTorchConv3D$new()`](#method-PipeOpTorchConv3D-initialize)

- [`PipeOpTorchConv3D$clone()`](#method-PipeOpTorchConv3D-clone)
...
pipeop = nn("conv3d", kernel_size = 10, out_channels = 1)
pipeop
#> 
#> ── PipeOp <conv3d>: not trained ────────────────────────────────────────────────
