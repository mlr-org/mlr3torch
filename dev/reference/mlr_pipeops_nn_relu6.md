...
Calls
[`torch::nn_relu6()`](https://torch.mlverse.org/docs/reference/nn_relu6.html)
when trained.
...
- [`PipeOpTorchReLU6$new()`](#method-PipeOpTorchReLU6-initialize)

- [`PipeOpTorchReLU6$clone()`](#method-PipeOpTorchReLU6-clone)
