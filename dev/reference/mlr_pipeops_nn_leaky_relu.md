...
- [`PipeOpTorchLeakyReLU$new()`](#method-PipeOpTorchLeakyReLU-initialize)

- [`PipeOpTorchLeakyReLU$clone()`](#method-PipeOpTorchLeakyReLU-clone)
...
pipeop
#> 
#> ── PipeOp <nn_leaky_relu>: not trained ─────────────────────────────────────────
#> Values: list()
#> 
#> ── Input channels: 
#>    name           train predict
