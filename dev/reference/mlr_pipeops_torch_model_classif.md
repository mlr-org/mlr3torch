...
#> torch_tensor
#>  0.7917  0.2744  0.9649  0.4274
#> -0.2950 -0.0920 -0.3904 -0.1728
#> -0.4967 -0.1825 -0.5745 -0.2546
#> [ CPUFloatType{3,4} ]
#> 
#> $optimizer$state$`1`$exp_avg_sq
#> torch_tensor
#> 0.01 *
#>  2.5521  0.3063  3.7919  0.7442
#>   0.3616  0.0353  0.6309  0.1253
#>   1.0087  0.1356  1.3506  0.2656
#> [ CPUFloatType{3,4} ]
#> 
