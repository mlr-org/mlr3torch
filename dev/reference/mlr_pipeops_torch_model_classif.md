...
#> torch_tensor
#> -0.1004 -0.0140 -0.3768 -0.2627
#> -0.3757 -0.1176 -0.5112 -0.2338
#>  0.4761  0.1316  0.8879  0.4965
#> [ CPUFloatType{3,4} ]
#> 
#> $optimizer$state$`1`$exp_avg_sq
#> torch_tensor
#> 0.01 *
#>  0.0464  0.0011  0.6439  0.3114
#>   0.5821  0.0573  1.0747  0.2264
#>   0.9357  0.0719  3.2932  1.0371
#> [ CPUFloatType{3,4} ]
#> 
