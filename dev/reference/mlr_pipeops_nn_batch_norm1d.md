...
Calls
[`torch::nn_batch_norm1d()`](https://torch.mlverse.org/docs/reference/nn_batch_norm1d.html).
...
-\>
[`PipeOpTorch`](https://mlr3torch.mlr-org.com/dev/reference/mlr_pipeops_torch.md)
-\> `PipeOpTorchBatchNorm` -\> `PipeOpTorchBatchNorm1D`

## Methods

### Public methods

- [`PipeOpTorchBatchNorm1D$new()`](#method-PipeOpTorchBatchNorm1D-initialize)

- [`PipeOpTorchBatchNorm1D$clone()`](#method-PipeOpTorchBatchNorm1D-clone)
...
pipeop = nn("batch_norm1d")
pipeop
#> 
#> ── PipeOp <batch_norm1d>: not trained ──────────────────────────────────────────
#> Values: list()
#> 
#> ── Input channels: 
#>    name           train predict
