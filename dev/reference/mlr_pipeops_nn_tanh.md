...
Calls
[`torch::nn_tanh()`](https://torch.mlverse.org/docs/reference/nn_tanh.html)
when trained.
...
- [`PipeOpTorchTanh$new()`](#method-PipeOpTorchTanh-initialize)

- [`PipeOpTorchTanh$clone()`](#method-PipeOpTorchTanh-clone)
