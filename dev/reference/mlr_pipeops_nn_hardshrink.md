...
Calls
[`torch::nn_hardshrink()`](https://torch.mlverse.org/docs/reference/nn_hardshrink.html)
when trained.

## Parameters

- `lambd` :: `numeric(1)`  
  The lambda value for the Hardshrink formulation formulation. Default
  0.5.
...
- [`PipeOpTorchHardShrink$new()`](#method-PipeOpTorchHardShrink-initialize)

- [`PipeOpTorchHardShrink$clone()`](#method-PipeOpTorchHardShrink-clone)
...
pipeop
#> 
#> ── PipeOp <nn_hardshrink>: not trained ─────────────────────────────────────────
#> Values: list()
#> 
#> ── Input channels: 
#>    name           train predict
...
#> 1:  lambd ParamDbl  -Inf   Inf     Inf     0.5 [NULL]
```
