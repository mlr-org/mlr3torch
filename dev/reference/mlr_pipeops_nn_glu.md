...
Calls
[`torch::nn_glu()`](https://torch.mlverse.org/docs/reference/nn_glu.html)
when trained.
...
- [`PipeOpTorchGLU$new()`](#method-PipeOpTorchGLU-initialize)

- [`PipeOpTorchGLU$clone()`](#method-PipeOpTorchGLU-clone)
...
#> 1:    dim ParamInt     1   Inf     Inf      -1 [NULL]
```
