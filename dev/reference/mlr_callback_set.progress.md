...
learner$train(task)
#> Epoch 1 started (2026-08-01 12:44:58)
#> Validation for epoch 1 started (2026-08-01 12:44:59)
#> 
#> [Summary epoch 1]
#> ------------------
#> Measures (Train):
...
#>  * classif.ce = 0.62
#> 
#> Epoch 2 started (2026-08-01 12:44:59)
#> Validation for epoch 2 started (2026-08-01 12:44:59)
#> 
#> [Summary epoch 2]
#> ------------------
#> Measures (Train):
...
#>  * classif.ce = 0.56
#> 
#> Epoch 3 started (2026-08-01 12:44:59)
#> Validation for epoch 3 started (2026-08-01 12:44:59)
#> 
#> [Summary epoch 3]
#> ------------------
#> Measures (Train):
...
#>  * classif.ce = 0.44
#> 
#> Epoch 4 started (2026-08-01 12:45:00)
#> Validation for epoch 4 started (2026-08-01 12:45:00)
#> 
#> [Summary epoch 4]
#> ------------------
#> Measures (Train):
...
#>  * classif.ce = 0.49
#> 
#> Epoch 5 started (2026-08-01 12:45:00)
#> Validation for epoch 5 started (2026-08-01 12:45:00)
#> 
#> [Summary epoch 5]
#> ------------------
#> Measures (Train):
...
#>  * classif.ce = 0.60
#> 
#> Finished training for 5 epochs (2026-08-01 12:45:00)
```
