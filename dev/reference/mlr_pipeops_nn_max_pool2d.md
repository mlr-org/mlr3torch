...
Calls
[`torch::nn_max_pool2d()`](https://torch.mlverse.org/docs/reference/nn_max_pool2d.html)
during training.
...
-\>
[`PipeOpTorch`](https://mlr3torch.mlr-org.com/dev/reference/mlr_pipeops_torch.md)
-\> `PipeOpTorchMaxPool` -\> `PipeOpTorchMaxPool2D`

## Methods

### Public methods

- [`PipeOpTorchMaxPool2D$new()`](#method-PipeOpTorchMaxPool2D-initialize)

- [`PipeOpTorchMaxPool2D$clone()`](#method-PipeOpTorchMaxPool2D-clone)
...
pipeop = nn("max_pool2d")
pipeop
#> 
#> ── PipeOp <max_pool2d>: not trained ────────────────────────────────────────────
#> Values: list()
#> 
#> ── Input channels: 
#>    name           train predict
