...
Calls
[`torch::nn_hardsigmoid()`](https://torch.mlverse.org/docs/reference/nn_hardsigmoid.html)
when trained.
...
- [`PipeOpTorchHardSigmoid$new()`](#method-PipeOpTorchHardSigmoid-initialize)

- [`PipeOpTorchHardSigmoid$clone()`](#method-PipeOpTorchHardSigmoid-clone)
...
pipeop = nn("hardsigmoid")
pipeop
#> 
#> ── PipeOp <hardsigmoid>: not trained ───────────────────────────────────────────
#> Values: list()
#> 
#> ── Input channels: 
#>    name           train predict
