...
Calls
[`torch::nn_flatten()`](https://torch.mlverse.org/docs/reference/nn_flatten.html)
when trained.
...
- [`PipeOpTorchFlatten$new()`](#method-PipeOpTorchFlatten-initialize)

- [`PipeOpTorchFlatten$clone()`](#method-PipeOpTorchFlatten-clone)
