...
Calls
[`nn_avg_pool1d()`](https://torch.mlverse.org/docs/reference/nn_avg_pool1d.html)
during training.
...
- `ceil_mode` :: [`integer()`](https://rdrr.io/r/base/integer.html)  
...
-\> `mlr3torch::PipeOpTorchAvgPool` -\> `PipeOpTorchAvgPool1D`

## Methods

### Public methods

- [`PipeOpTorchAvgPool1D$new()`](#method-PipeOpTorchAvgPool1D-new)

- [`PipeOpTorchAvgPool1D$clone()`](#method-PipeOpTorchAvgPool1D-clone)
...
pipeop
#> 
#> ── PipeOp <nn_avg_pool1d>: not trained ─────────────────────────────────────────
#> Values: list()
#> 
#> ── Input channels: 
#>    name           train predict
