...
Calls
[`nn_conv_transpose3d`](https://torch.mlverse.org/docs/reference/nn_conv_transpose3d.html).
...
- `padding` :: ` `integer()`\cr `dilation \* (kernel_size - 1) -
  padding\` zero-padding will be added to both sides of the input.
  Default: 0.
...
-\>
[`PipeOpTorch`](https://mlr3torch.mlr-org.com/dev/reference/mlr_pipeops_torch.md)
-\> `PipeOpTorchConvTranspose` -\> `PipeOpTorchConvTranspose3D`

## Methods

### Public methods

- [`PipeOpTorchConvTranspose3D$new()`](#method-PipeOpTorchConvTranspose3D-initialize)

- [`PipeOpTorchConvTranspose3D$clone()`](#method-PipeOpTorchConvTranspose3D-clone)
...
pipeop
#> 
#> ── PipeOp <nn_conv_transpose3d>: not trained ───────────────────────────────────
