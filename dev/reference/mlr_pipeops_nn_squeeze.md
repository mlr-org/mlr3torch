...
Squeezes a tensor by calling
[`torch::torch_squeeze()`](https://torch.mlverse.org/docs/reference/torch_squeeze.html)
...
- [`PipeOpTorchSqueeze$new()`](#method-PipeOpTorchSqueeze-initialize)

- [`PipeOpTorchSqueeze$clone()`](#method-PipeOpTorchSqueeze-clone)
...
#> 1:    dim ParamUty    NA    NA     Inf <NoDefault[0]> [NULL]
```
