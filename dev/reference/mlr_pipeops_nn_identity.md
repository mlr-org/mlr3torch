...
Calls
[`torch::nn_identity()`](https://torch.mlverse.org/docs/reference/nn_identity.html)
when trained, which passes the input unchanged to the output.
...
- [`PipeOpTorchIdentity$new()`](#method-PipeOpTorchIdentity-initialize)

- [`PipeOpTorchIdentity$clone()`](#method-PipeOpTorchIdentity-clone)
...
pipeop
#> 
#> ── PipeOp <nn_identity>: not trained ───────────────────────────────────────────
#> Values: list()
#> 
#> ── Input channels: 
#>    name           train predict
