...
Calls
[`torch::nn_log_sigmoid()`](https://torch.mlverse.org/docs/reference/nn_log_sigmoid.html)
when trained.
...
- [`PipeOpTorchLogSigmoid$new()`](#method-PipeOpTorchLogSigmoid-initialize)

- [`PipeOpTorchLogSigmoid$clone()`](#method-PipeOpTorchLogSigmoid-clone)
...
pipeop = nn("log_sigmoid")
pipeop
#> 
#> ── PipeOp <log_sigmoid>: not trained ───────────────────────────────────────────
#> Values: list()
#> 
#> ── Input channels: 
#>    name           train predict
