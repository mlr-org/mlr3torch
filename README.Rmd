...
Using predefined learners such as a simple multi layer perceptron (MLP) works just like other mlr3 `Learner`s.
...
It can also be tuned using [mlr3tuning](https://mlr3tuning.mlr-org.com/).
