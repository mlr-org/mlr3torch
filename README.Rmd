...
It makes it easy to build, train and evaluate deep learning models in a few lines of code, without needing to worry about low-level details.
...
It wraps a `torch::dataset`, but makes it possible to preprocess the data (lazily) using `PipeOp` objects.
...
* The paper [*mlr3torch: A Deep Learning Framework in R based on mlr3 and torch*](https://arxiv.org/abs/2604.18152) gives an overview of the package.
