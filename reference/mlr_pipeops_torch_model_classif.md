...
#> torch_tensor
#> -0.1093 -0.0154 -0.4114 -0.2869
#> -0.1966 -0.0582 -0.2657 -0.1161
#>  0.3059  0.0736  0.6771  0.4030
#> [ CPUFloatType{3,4} ]
#> 
#> $optimizer$state$`1`$exp_avg_sq
#> torch_tensor
#> 0.01 *
#>  0.0487  0.0010  0.6896  0.3349
#>   0.1689  0.0149  0.3124  0.0621
#>   0.3920  0.0233  1.8857  0.6653
#> [ CPUFloatType{3,4} ]
#> 
