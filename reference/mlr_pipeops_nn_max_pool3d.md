...
Calls
[`torch::nn_max_pool3d()`](https://torch.mlverse.org/docs/reference/nn_max_pool3d.html)
during training.
...
-\> `mlr3torch::PipeOpTorchMaxPool` -\> `PipeOpTorchMaxPool3D`

## Methods

### Public methods

- [`PipeOpTorchMaxPool3D$new()`](#method-PipeOpTorchMaxPool3D-new)

- [`PipeOpTorchMaxPool3D$clone()`](#method-PipeOpTorchMaxPool3D-clone)
...
pipeop
#> 
#> ── PipeOp <nn_max_pool3d>: not trained ─────────────────────────────────────────
#> Values: list()
#> 
#> ── Input channels: 
#>    name           train predict
