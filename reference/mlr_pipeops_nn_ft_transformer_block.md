...
-\> `PipeOpTorchFTTransformerBlock`

## Methods

### Public methods

- [`PipeOpTorchFTTransformerBlock$new()`](#method-PipeOpTorchFTTransformerBlock-new)

- [`PipeOpTorchFTTransformerBlock$clone()`](#method-PipeOpTorchFTTransformerBlock-clone)
