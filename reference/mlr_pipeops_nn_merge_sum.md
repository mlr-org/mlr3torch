...
-\>
[`mlr3torch::PipeOpTorchMerge`](https://mlr3torch.mlr-org.com/reference/mlr_pipeops_nn_merge.md)
-\> `PipeOpTorchMergeSum`
...
- [`PipeOpTorchMergeSum$new()`](#method-PipeOpTorchMergeSum-new)
...
pipeop
#> PipeOp: <nn_merge_sum> (not trained)
#> values: <list()>
