...
test_that("CIFAR-10 works", {
  ...
  expect_equal(task$man, "mlr3torch::mlr_tasks_tinyimagenet")
  task$data()
  expect_true("cifar-10-batches-bin" %in% list.files(file.path(get_cache_dir(), "datasets", "tiny_imagenet", "raw")))
