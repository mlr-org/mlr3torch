...
\pkg{luz}, by contrast, is currently more flexible than \mlrttorch{}, and allows to define custom training loops, e.g., to train variational autoencoders, whereas \mlrttorch{} is currently focused on supervised learning, namely regression and classification.
...
This will be done using the predefined \code{"california\_housing"} example problem \citep{ref-pace1997sparse}, where the goal is to predict the median house value in California.
