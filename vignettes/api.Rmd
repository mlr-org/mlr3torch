...
The number of arguments of the forward function must coincide with the number of channels
of the TorchOp. In case the TorchOp has a vararg channel (...), the layer's forward function
