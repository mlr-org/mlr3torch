...
Note that in the code below `nn("relu_1")` is equivalent to `nn("relu", id = "nn_relu_1")`.
...
In order to repeat a segment from a network multiple times, we can use `nn("block")`, which we here repeat twice.
