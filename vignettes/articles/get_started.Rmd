...
Both learners are given 100 epochs so the comparison is not about how fast they converge, but about where they end up.
...
Because scaling is a property of the data and not of a specific architecture, this applies to all tabular learners of `mlr3torch`, such as `lrn("regr.tab_resnet")` or `lrn("classif.ft_transformer")`.
