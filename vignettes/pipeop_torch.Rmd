...
Before training the model, we set some more hyperparameters. Among others, we use a [`CallbackSet`] that prints progress and validation losses that we request.
